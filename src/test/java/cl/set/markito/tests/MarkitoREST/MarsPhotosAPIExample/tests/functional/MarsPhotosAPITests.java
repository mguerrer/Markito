package cl.set.markito.tests.MarkitoREST.MarsPhotosAPIExample.tests.functional;
...
import cl.set.markito.tests.MarkitoREST.MarsPhotosAPIExample.framework.*;
import cl.set.markito.tests.MarkitoREST.MarsPhotosAPIExample.framework.types.*;
